...
[x] Get a card table: GET /buckets/:id/card_tables/:id.json
[ ] Create a column: POST /buckets/:id/card_tables/:id/columns.json
[ ] Move a column: POST /buckets/:id/card_tables/:id/moves.json
[x] Get a card: GET /buckets/:id/card_tables/cards/:id.json
[x] Update a card: PUT /buckets/:id/card_tables/cards/:id.json
[x] Move a card: POST /buckets/:id/card_tables/cards/:id/moves.json
[ ] Reposition a step: POST /buckets/:id/card_tables/cards/:id/positions.json
[x] Create a step: POST /buckets/:id/card_tables/cards/:id/steps.json
...
[x] Get cards in a column: GET /buckets/:id/card_tables/lists/:id/cards.json
[x] Create a card: POST /buckets/:id/card_tables/lists/:id/cards.json
...
[x] Get message types: GET /buckets/:id/categories.json
...
[x] Get a comment: GET /buckets/:id/comments/:id.json
[x] Update a comment: PUT /buckets/:id/comments/:id.json
...
[x] Get messages: GET /buckets/:id/message_boards/:id/messages.json
[x] Create a message: POST /buckets/:id/message_boards/:id/messages.json
[x] Get a message: GET /buckets/:id/messages/:id.json
[x] Update a message: PUT /buckets/:id/messages/:id.json
...
[x] Get comments: GET /buckets/:id/recordings/:id/comments.json
[x] Create a comment: POST /buckets/:id/recordings/:id/comments.json
...
[x] Get to-dos: GET /buckets/:id/todolists/:id/todos.json
[x] Create a to-do: POST /buckets/:id/todolists/:id/todos.json
...
[x] Uncomplete a to-do: DELETE /buckets/:id/todos/:id/completion.json
[x] Complete a to-do: POST /buckets/:id/todos/:id/completion.json
[ ] Reposition a to-do: PUT /buckets/:id/todos/:id/position.json
[x] Get to-do set: GET /buckets/:id/todosets/:id.json
[x] Get to-do lists: GET /buckets/:id/todosets/:id/todolists.json
...
[x] Get my personal info: GET /my/profile.json
[x] Get all people: GET /people.json
[x] Get person: GET /people/:id.json
[x] Get all projects: GET /projects.json
[ ] Create a project: POST /projects.json
[ ] Trash a project: DELETE /projects/:id.json
[x] Get a project: GET /projects/:id.json
